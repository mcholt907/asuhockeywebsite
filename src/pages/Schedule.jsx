...
function Schedule() {
  ...
  return (
    <div className="page-container schedule-page">
      <Helmet>
        <title>{`ASU Hockey Schedule & Scores (${SEASON_FULL}) | Forks Up Pucks`}</title>
        <meta
          name="description"
          content={`Full ${SEASON_SHORT} ASU Sun Devils Men's Hockey schedule, live scores, broadcast details, and game results.`}
        />
        <meta
          property="og:title"
          content={`ASU Hockey Schedule & Scores (${SEASON_FULL}) | Forks Up Pucks`}
        />
        <meta
                ...
                })),
                {
                  ...
                  itemListElement: [
                    ...
                    },
                    {
                      ...
                      position: 2,
                      name: "Schedule",
                      item: "https://forksuppucks.com/schedule/",
                    },
                  ],
                },
              ],
          ...
          {games.map((game, index) => {
            return (
              <li
                ...
                className={`schedule-item ${game.status ? game.status.toLowerCase() : ""}`}
              >
                <div className="game-date-time">
                  ...
                  {game.status && (
                    <span
                      className={`game-venue-tag ${game.status.toLowerCase()}`}
                    >
                      {game.status}
                    </span>
                  )}
                ...
                <div className="game-details">
                  <span className="game-opponent">
                    <span className="game-venue-vs">
                      {game.status === "Home" ? "vs" : "@"}
                    </span>{" "}
                    {game.opponent}
                  </span>
                  {game.notes && (
                    <span className="game-notes">({game.notes})</span>
                  )}
                </div>
                ...
                {game.result && (
                  <div className="game-result-col">
                    <div
                      className={`result-badge result-badge-${game.result.charAt(0).toLowerCase()}`}
                    >
                      <span className="result-badge-letter">
